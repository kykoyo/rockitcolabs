...
Users.create(:name =>'Bob', :email=>'bob@bob.com', :user_type=>'superadmin', :phone => 4151234567)
Users.create(:name =>'Anthony', :email => 'anthony@anthony.com', :user_type => 'admin', :phone => 4152345678)
Users.create(:name =>'George', :email =>'george@george.com', :user_type =>'member', :phone =>4153456789)
